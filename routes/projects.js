...
{
  res.render("templates/item.ejs", {active: "projects", css: "/stylesheets/specialclarify.css", item: projectsinfoJSON[2], links: projectsinfoJSON[2].links, credits:" Developed by Elliot Winch and Carlos-Michael Rodriguez", images: projectsinfoJSON[2].images});
});
